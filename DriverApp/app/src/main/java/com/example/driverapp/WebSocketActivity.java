...
public class WebSocketActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Baihupe";
    private static final String SERVER_URL = "ws://192.168.1.108:80/websocket/driver_1";    /** 需要提前写死 **/
