...
public class AddProductScan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_scan);

        rl_scan = findViewById(R.id.rl_scan2);
        iv_back = findViewById(R.id.iv_back2);
        iv_flash = findViewById(R.id.iv_flash2);
        iv_album = findViewById(R.id.iv_album2);
    ...
    private void showResult(HmsScan[] result) {
        if (result != null && result.length > 0 && result[0] != null &&
            ...
            Intent intent = new Intent(AddProductScan.this, AddProductResult.class);
